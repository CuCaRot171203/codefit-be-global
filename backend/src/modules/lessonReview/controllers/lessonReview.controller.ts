...
class LessonReviewController extends BaseController {
  ...
  getPendingReviews = async (req: Request, res: Response, next: Function) => {
    try {
  ...
  getReviewDetails = async (req: Request, res: Response, next: Function) => {
    try {
  ...
  // Approve a lesson
  approve = async (req: Request, res: Response, next: Function) => {
    try {
      const { lessonId } = req.params;
  ...
  // Reject a lesson
  reject = async (req: Request, res: Response, next: Function) => {
    try {
      const { lessonId } = req.params;
      const { feedback } = req.body;
      const adminId = req.user?.userId;
  ...
  // Publish a lesson
  publish = async (req: Request, res: Response, next: Function) => {
    try {
      const { lessonId } = req.params;
      const adminId = req.user?.userId;
  ...
  batchApprove = async (req: Request, res: Response, next: Function) => {
    try {
  ...
  batchPublish = async (req: Request, res: Response, next: Function) => {
    try {
      const { lessonIds } = req.body;
      const adminId = req.user?.userId;
  ...
  // Get all reviews
  getAllReviews = async (req: Request, res: Response, next: Function) => {
    try {
