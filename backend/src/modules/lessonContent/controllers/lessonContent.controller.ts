...
class LessonContentController extends BaseController {
  ...
  getByLessonId = async (req: Request, res: Response, next: Function) => {
    try {
  ...
  updateContent = async (req: Request, res: Response, next: Function) => {
    try {
      const { lessonId } = req.params;
  ...
  // Get scoring config
  getScoringConfig = async (req: Request, res: Response, next: Function) => {
    try {
      const { lessonId } = req.params;
  ...
  updateScoringConfig = async (req: Request, res: Response, next: Function) => {
    try {
      const { lessonId } = req.params;
