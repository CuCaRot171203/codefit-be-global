 ...
 */
class ProblemService extends BaseService<typeof problemRepository> {
   ...
   */
  async create(dto: CreateProblemDto): Promise<any> {
   ...
   */
  async getPublicTestcases(problemId: string): Promise<any[]> {
   ...
   * @throws Error if the problem is not found
   */
  async update(id: string, dto: UpdateProblemDto): Promise<any> {
