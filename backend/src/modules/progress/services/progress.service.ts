 ...
 */
class ProgressService extends BaseService<typeof progressRepository> {
   ...
   */
  async getProgress(userId: string, courseId: string): Promise<any | null> {
   ...
   */
  async incrementProgress(userId: string, courseId: string): Promise<any> {
