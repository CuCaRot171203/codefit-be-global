 ...
 * @extends BaseService
 */
class CertificateService extends BaseService<typeof certificateRepository> {
   ...
   */
  async getCertificate(userId: string, courseId: string): Promise<any | null> {
   ...
   */
  async generateForCourseCompletion(userId: string, courseId: string): Promise<any> {
   ...
   */
  async generateForProjectSubmission(userId: string, courseId: string): Promise<any> {
