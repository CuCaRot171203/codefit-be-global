 ...
 */
class NotificationService extends BaseService<typeof notificationRepository> {
   ...
   */
  async getSentNotifications(userId: string): Promise<any[]> {
   ...
   */
  async createHackathonReminderNotification(
    userId: string,
   ...
   */
  async createHackathonJoinedNotification(
    userId: string,
    hackathonTitle: string,
    hackathonId: string
  ): Promise<any> {
   ...
   */
  async createHackathonStartedNotification(
    userId: string,
    hackathonTitle: string,
    hackathonId: string
  ): Promise<any> {
