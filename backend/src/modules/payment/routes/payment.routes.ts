...
router.post('/activate', verifyToken, (req, res, next) => 
  paymentController.activateWithCode(req, res, next)
);
 ...
 * Yêu cầu: Token xác thực hợp lệ
 */
router.get('/:id/status', verifyToken, (req, res, next) => 
  paymentController.checkPaymentStatus(req, res, next)
);
 ...
 * Yêu cầu: Token xác thực hợp lệ
 */
router.post('/:id/cancel', verifyToken, (req, res, next) => 
 ...
 */
router.post('/sepay/ipn', (req, res, next) => 
  paymentController.sepayIpn(req, res, next)
);
 ...
 */
router.post('/sepay/callback', (req, res, next) => 
  paymentController.sepayCallback(req, res, next)
);
 ...
 */
router.post('/admin/create-code', verifyToken, (req, res, next) =>
  paymentController.createActivateCode(req, res, next)
);
 ...
 */
router.post('/payos/create', verifyToken, (req, res, next) =>
  paymentController.createPayOSPaymentLink(req, res, next)
);
 ...
 */
router.post('/payos/cancel-payment', verifyToken, (req, res, next) =>
  paymentController.cancelPayOSPayment(req, res, next)
);
 ...
 */
router.post('/payos/webhook', (req, res, next) =>
  paymentController.payosWebhook(req, res, next)
);
 ...
 */
router.post('/payos/confirm', verifyToken, (req, res, next) =>
  paymentController.confirmPayOSPayment(req, res, next)
);
