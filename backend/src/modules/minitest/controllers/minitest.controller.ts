 ...
 */
class MinitestController extends BaseController {
  constructor() {
    super(minitestService);
  }
   ...
   * @param next - Next function để xử lý lỗi
   */
  getByCourseId = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export default new MinitestController();
