...
declare class LessonProgressRepository extends BaseRepository<LessonProgress> {
     ...
     */
    findByUserAndCourse(userId: string, courseId: string): Promise<LessonProgress[]>;
    /**
     ...
     */
    markComplete(userId: string, lessonId: string, courseId: string): Promise<LessonProgress>;
    /**
