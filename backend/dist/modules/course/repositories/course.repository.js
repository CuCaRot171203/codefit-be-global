...
class CourseRepository extends BaseRepository {
     ...
     */
    async findAll() {
        // Bước 1: Sử dụng Prisma findMany để lấy tất cả records
        return this.model.findMany({
            // Bước 2: Sắp xếp theo createdAt giảm dần (mới nhất trước)
    ...
    async findByCreatorId(creatorId) {
        // Bước 1: Xây dựng query với điều kiện lọc theo creatorId
        return this.model.findMany({
            // Bước 2: Filter chỉ lấy các course có creatorId tương ứng
            where: { creatorId },
            // Bước 3: Sắp xếp theo thời gian tạo giảm dần
            orderBy: { createdAt: 'desc' }
        });
    }
    /**
