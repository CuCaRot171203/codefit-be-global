 ...
 */
export function calculateUnlockedLessons(courseConfig, enrollment, totalLessons) {
 ...
 */
export function isLessonUnlocked(lesson, courseConfig, enrollment, totalLessons) {
 ...
 */
export async function getUnlockedLessons(userId, courseId) {
    // Get course config
 ...
 */
export async function completeLessonAndUnlock(userId, courseId, lessonId) {
