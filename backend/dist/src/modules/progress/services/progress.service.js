...
const progress_repository_1 = __importDefault(require("../repositories/progress.repository"));
 ...
 */
class ProgressService extends base_service_1.BaseService {
    constructor() {
        super(progress_repository_1.default);
    }
    /**
