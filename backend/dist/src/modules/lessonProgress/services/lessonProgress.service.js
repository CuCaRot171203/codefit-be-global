...
const lessonProgress_repository_1 = __importDefault(require("../repositories/lessonProgress.repository"));
 ...
 * @extends BaseService
 */
class LessonProgressService extends base_service_1.BaseService {
    constructor() {
        super(lessonProgress_repository_1.default);
    }
    /**
...
exports.default = new LessonProgressService();
