...
const lessonProgress_service_1 = __importDefault(require("../services/lessonProgress.service"));
/**
 * LessonProgressController - HTTP layer cho tiến độ bài học
 * @class LessonProgressController
 * @extends BaseController
 */
class LessonProgressController extends base_controller_1.BaseController {
    constructor() {
        super(lessonProgress_service_1.default);
    }
    /**
...
exports.default = new LessonProgressController();
