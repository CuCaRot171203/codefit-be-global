...
const lessonRequest_service_1 = __importDefault(require("../services/lessonRequest.service"));
class LessonRequestController extends base_controller_1.BaseController {
    constructor() {
        super(lessonRequest_service_1.default);
    }
    // ========== Admin Endpoints ==========
...
exports.default = new LessonRequestController();
