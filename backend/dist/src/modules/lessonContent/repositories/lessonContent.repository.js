...
class LessonContentRepository extends base_repository_1.BaseRepository {
    model = prisma.lessonContent;
...
class ScoringConfigRepository extends base_repository_1.BaseRepository {
    model = prisma.scoringConfig;
    async findByLessonId(lessonId) {
        return this.model.findUnique({
            where: { lessonId },
        });
...
//# sourceMappingURL=lessonContent.repository.js.map