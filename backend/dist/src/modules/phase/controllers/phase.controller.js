...
const phase_service_1 = __importDefault(require("../services/phase.service"));
/**
 * PhaseController - HTTP layer cho Phase operations
 * @class PhaseController
 * @extends BaseController
 */
class PhaseController extends base_controller_1.BaseController {
    constructor() {
        super(phase_service_1.default);
    }
    /**
     * Tạo mới một phase
     * POST /api/phases
...
exports.default = new PhaseController();
