...
exports.calculateUnlockedLessons = calculateUnlockedLessons;
exports.isLessonUnlocked = isLessonUnlocked;
exports.getUnlockedLessons = getUnlockedLessons;
exports.completeLessonAndUnlock = completeLessonAndUnlock;
const prisma_1 = __importDefault(require("../../prisma"));
/**
 * Tính số bài học được mở khóa dựa trên progress
 */
function calculateUnlockedLessons(courseConfig, enrollment, totalLessons) {
 ...
 */
function isLessonUnlocked(lesson, courseConfig, enrollment, totalLessons) {
 ...
 */
async function getUnlockedLessons(userId, courseId) {
    // Get course config
 ...
 */
async function completeLessonAndUnlock(userId, courseId, lessonId) {
    ...
    await prisma_1.default.lessonProgress.upsert({
        where: {
...
//# sourceMappingURL=progressiveUnlock.service.js.map