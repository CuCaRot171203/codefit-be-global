...
const problem_repository_1 = __importDefault(require("../repositories/problem.repository"));
/**
 * ProblemService class
 * @extends BaseService
 * @description Handles business logic and validation for problem operations.
 */
class ProblemService extends base_service_1.BaseService {
    constructor() {
        super(problem_repository_1.default);
    }
    /**
     * Get all problems
