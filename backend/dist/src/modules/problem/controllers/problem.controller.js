...
const problem_service_1 = __importDefault(require("../services/problem.service"));
/**
 ...
 */
class ProblemController extends base_controller_1.BaseController {
    /**
     * Constructor
     * @description Initializes the controller with the problem service.
     */
    constructor() {
        super(problem_service_1.default);
    }
    /**
     * Get all problems
