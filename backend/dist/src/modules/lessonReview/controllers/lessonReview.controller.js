...
const lessonReview_service_1 = __importDefault(require("../services/lessonReview.service"));
class LessonReviewController extends base_controller_1.BaseController {
    constructor() {
        super(lessonReview_service_1.default);
    }
...
exports.default = new LessonReviewController();
