...
async function main() {
    ...
    // ============================================
    const createProblem = async (id, title, description, difficulty, testCases) => {
    ...
    // ============================================
    const createLesson = async (phaseId, title, orderIndex, content, starterCode, testCases, hints) => {
    ...
    // ============================================
    const createMinitest = async (phaseId, title, orderIndex, problems) => {
    ...
    const prob1 = await createProblem('prob-m1-hello', 'In dòng chữ (Minitest Chương 1)', 'In ra dòng chữ "Hello World"', 'EASY', [
        { id: 'tc-m1-h1', input: '', expectedOutput: 'Hello World', isPublic: true },
    ]);
    // Lesson 1.1: Hello World
    const lesson1_1 = await createLesson(phase1.id, 'Bài 1.1: Hello World', 1, `<h2>Bài 1.1: In dòng chữ đầu tiên</h2>
...
print("Hello World")`, [
    ...
    const prob2 = await createProblem('prob-m2-sum', 'Tính tổng 2 số (Minitest Chương 2)', 'Tính tổng của 2 số nguyên', 'EASY', [
    ...
    const lesson2_1 = await createLesson(phase2.id, 'Bài 2.1: Tính tổng 2 số', 1, `<h2>Bài 2.1: Tính tổng 2 số nguyên</h2>
...
</ul>`, `# Đọc input và tính tổng 2 số
# Input: 2 số nguyên
...
print(a + b)`, [
    ...
    const prob3 = await createProblem('prob-m3-factorial', 'Tính giai thừa (Minitest Chương 3)', 'Tính giai thừa của một số nguyên dương', 'EASY', [
    ...
    const lesson3_1 = await createLesson(phase3.id, 'Bài 3.1: Tính giai thừa', 1, `<h2>Bài 3.1: Tính giai thừa</h2>
...
print(result)`, [
    ...
    const probFinal1 = await createProblem('prob-final-1', 'Kiểm tra số nguyên tố', 'Kiểm tra xem một số có phải là số nguyên tố hay không', 'MEDIUM', [
        { id: 'tc-f1-1', input: '7', expectedOutput: 'true', isPublic: true },
        { id: 'tc-f1-2', input: '4', expectedOutput: 'false', isPublic: true },
    ]);
    const probFinal2 = await createProblem('prob-final-2', 'Fibonacci', 'Tính số Fibonacci thứ n', 'MEDIUM', [
...
//# sourceMappingURL=seedCourseWithFinalProject.js.map